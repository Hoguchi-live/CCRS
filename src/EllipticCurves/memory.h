...
void MG_point_set(MG_point_t *, const fq_t, const fq_t, MG_curve_t *); // RENAME _fq
void MG_point_set_(MG_point_t *, MG_point_t *); // The real one
...
void TN_curve_set(TN_curve_t *, const fq_ctx_t *, const fq_t, const fq_t);
void TN_curve_set_si(TN_curve_t *, const fq_ctx_t *, const slong, const slong);
int TN_curve_set_str(TN_curve_t *, const fq_ctx_t *, const char *, const char *, int);
