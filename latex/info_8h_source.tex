...
\label{info_8h_source}\index{src/Exchange/info.h@{src/Exchange/info.h}}
...
\DoxyCodeLine{14 }
\DoxyCodeLine{15 \textcolor{keywordtype}{void} print\_verbose\_walk\_rad(uint, fmpz\_t, fmpz\_t, \textcolor{keywordtype}{int}, \textcolor{keywordtype}{int});}
