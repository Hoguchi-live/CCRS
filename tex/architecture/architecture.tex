...
For a given elliptic curve $E$ and a point $P\in E$ of order $l$, Velu's formulas \cite produce expressions for the curve $E/<P>$.
In article \cite formulas are given to produce a point $Q\in E/<P>$ such that the composition
\[
...
The \textit{seed} and \textit{state} parameters can be used for reproductivity.
